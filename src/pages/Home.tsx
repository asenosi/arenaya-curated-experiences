          ...
          <div className="max-w-6xl mx-auto space-y-16 lg:space-y-24">
            ...
            <ScrollReveal>
              <div className="text-center md:text-left space-y-6 max-w-3xl">
                ...
                <div className="w-24 h-1 bg-rich-gold rounded-full hidden md:block" />
            ...
            {/* Editorial Staggered List */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 lg:gap-x-16 gap-y-12 md:gap-y-0">
              {/* Left Column */}
                ...
                {whyGiftingMatters.filter((_, i) => i % 2 === 0).map((item, index) => {
                  ...
                  return (
                    <ScrollReveal key={item.title} delay={index * 120} direction="left">
                      <div className="group flex items-start gap-5 lg:gap-6">
              ...
              <div className="space-y-12 lg:space-y-20 md:mt-32 lg:mt-48">
                {whyGiftingMatters.filter((_, i) => i % 2 !== 0).map((item, index) => {
